...
class SearchStateExplorer : public Solver<T_Cost, T_State, vector<Node<T_Cost, T_State>>, 
                                            ProblemStateExplorer<T_Cost, T_State>> {
    public:
        using state_type = T_State;
        using node_type = Types::node_type<T_Cost, T_State>;
        using problem_type = Types::explorer_problem_type<T_Cost, T_State>;
